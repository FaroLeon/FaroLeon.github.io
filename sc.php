...
function create() {
    ...
    var myid1 = myid;
    kd.href = 'http://zyj.lhhfaka.xyz/?id='+myid.value+'&url='+url.value;   //在这修改域名   替换就行
    kd.style = ''; 
    kd.innerText = 'https://zyj.lhhfaka.xyz/?id='+myid.value+'&url='+url.value; //两个都要替换    这就好了
  ...
  <body style="background-image: url(https://blog.mrabit.com/bing/today);">
    <div class="container">
      ...
      <ul class="nav nav-pills pull-right" role="tablist">
         <li role="presentation" class="active"><a href="https://kk888.52dg.cn/">爱准挂</a></li>     
        <li role="presentation" class="active"><a href="http://lhh.lhhfaka.xyz/">久伴发卡</a></li>
        <li role="presentation"><a href="https://jq.qq.com/?_wv=1027&k=PmnNjWgM" target="_blank">进入官方群</a></li>
      </ul>
      <h3 class="text-muted" align="left">
        <img src="/luyuz.png" width="150px" height="47px"></img><font color="#8968CD"><b>小朋友照妖镜</b></font>
      </h3>
    </div>
<hr class="hr1">
      ...
      <div class="panel panel-primary" style="margin:1% 1% 1% 1%;background: rgba(255, 251, 251, 0.7)">
        <div class="panel-body">
          <div class="alert alert-info" role="alert">
            ...
            <font color="#e600ff"><br>站长QQ:3274075188</font>
            <font color="#e600ff"><br>QQ群：664233330</font>
            <font color="#e600ff"><br><a href="https://kk888.52dg.cn/">爱准挂</a></font>
             <font color="#e600ff"><br><a href="http://lhh.lhhfaka.xyz/">久伴发卡</a></font>           
        ...
        <p style="text-align:center">
            &copy; Powered by
          <a href="https://jq.qq.com/?_wv=1027&k=PmnNjWgM">久伴</a>!</p>
